  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-sm text-gray-400 mb-6"><a href="/" className="hover:text-indigo-600">Home</a> / <a href="/categories" className="hover:text-indigo-600">Categories</a> / <span className="text-gray-700">{cat?.name||slug}</span></div>
        <h1 className="text-3xl font-bold text-gray-900 mb-2">{cat?.icon} {cat?.name}</h1>
        <p className="text-gray-500 mb-8">{tools.length} tools</p>
